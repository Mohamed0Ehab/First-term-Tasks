...
import subprocess  # To run Task5.py
...
class MPRViewerApp:
    def __init__(self, root):
        ...
        # New button for Task5
        self.task5_button = Button(root, text="Open Task 5 Viewer", command=self.open_task5)
        self.task5_button.pack(side="top", padx=5, pady=5)
        # Frame for Viewers
    ...
    def initialize_view(self):
        ...
        self.update_views()
    def open_task5(self):
        """Function to open Task5.py GUI"""
        try:
            # Launch Task5.py as a separate process
            subprocess.Popen(["python", "Task5.py"])
        except Exception as e:
      
           print(f"Error opening Task 5 Viewer: {e}")
